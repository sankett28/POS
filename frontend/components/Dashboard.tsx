    ...
    <section className="animate-fade-in">
      <div className="flex flex-col sm:flex-row justify-between items-start gap-4 sm:gap-0 mb-6 sm:mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 w-full sm:w-auto">
          <select className="px-3 sm:px-4 py-2 sm:py-2.5 border border-gray-300 rounded-md bg-white text-primary text-sm sm:text-base font-medium cursor-pointer transition-all hover:border-primary w-full sm:w-auto">
            <option>Today</option>
